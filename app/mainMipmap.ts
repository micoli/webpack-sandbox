/*require ('./main.css');
var shell = require("gl-now")({element:document.querySelector('#renderer'),clearColor: [0,0,0,0]})
var camera = require("game-shell-orbit-camera")(shell)
var createTileMap = require("gl-tile-map")
var ndarray1 = require("ndarray")
var terrain = require("isabella-texture-pack")
var glm = require("gl-matrix")
var createWireShader = require("./lib/wireShader")
...
//Load selectors
var selectModel:any = document.querySelector("#selectModel")
var showWire:any = document.querySelector("#showWire")
var selectMip:any = document.querySelector("#selectMip")
...
function meshChange() {
	...
	mesh = createVoxelMesh1(shell.gl, name, examples[name])
	var c = mesh.center
...
shell.on("gl-init", function() {
	...
	var tiles = ndarray1(terrain.data,

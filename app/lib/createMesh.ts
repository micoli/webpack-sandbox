...
function createVoxelMesh(gl, name, voxels) {
	...
	var wireVertexArray = ndarray3(new Uint8Array(wireVertexCount * 3), [triangleVertexCount, 2, 3])
	var trianglePositions = ndarray3(vert_data, [triangleVertexCount, 3], [8, 1], 0)
